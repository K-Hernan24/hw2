...
#Declaration of variables that hold actor hash
...
for movie in Movie.all
    ...
    p "#{title}, #{year_released}, #{rating}, #{studio["name"]}"
end
...
for role in Role.all
    ...
    p "#{movie_title}, #{actor_name}, #{character_name}"
end